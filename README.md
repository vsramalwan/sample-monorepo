...
3. To generate a new lib run `pnpm create-library -- <library-name> --project=<project-name>`
4. To generate a new app run `pnpm create-application -- <application-name> --project=<project-name>`
5. To generate a new storybook story for a React component `pnpm create-component-story -- <component-name>`
6. To generate stories for all components in library run `pnpm create-stories`
